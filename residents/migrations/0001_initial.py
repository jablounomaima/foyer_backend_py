...
<<<<<<< HEAD
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='reglement/', verbose_name='Image')),
                ('ordre', models.PositiveIntegerField(default=0, verbose_name="Ordre d'affichage")),
                ('mis_en_ligne', models.BooleanField(default=True, verbose_name='Afficher sur le site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_type', models.CharField(choices=[('single', 'Chambre simple'), ('double', 'Chambre double'), ('suite', 'Suite')], max_length=20)),
...
<<<<<<< HEAD
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Résident')),
            ],
            options={
